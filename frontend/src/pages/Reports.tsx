  ...
  return (
    <div className="flex-1 bg-[#f4f6fa] flex flex-col min-h-screen overflow-y-auto font-sans">
      ...
      <div className="p-7 space-y-5 max-w-[1600px] mx-auto w-full">
        ...
        <div className="bg-white rounded-xl p-5 border border-slate-200/80 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button
            onClick={() => alert("Generating customized court backlog analytics report...")}
